...
table.insert( jobs, {name = "Police Officer", color = Color( 125, 125, 125, 255 ), loadout = {"weapon_physgun", "weapon_physcannon","gmod_tool","weapon_pistol" }});	--creates an example police job stored in jobs[2]
